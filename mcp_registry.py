...
MCP_SERVERS: dict[str, MCPServer] = {
    ...
    "wandb": MCPServer(
        ...
        categories=["ml", "experiments", "tracking"],
        keywords=[
            "wandb",
            "weights and biases",
            "weave",
    ...
    # ============================================================
    # PHASE 4: Additional API Key Servers
    # ============================================================
    "tavily": MCPServer(
        name="tavily",
        url="https://mcp.tavily.com/mcp",
        auth_type="api_key",
        description="AI-optimized search engine for accurate, real-time information",
        categories=["search", "research", "web"],
        keywords=[
            "search",
            "research",
    ...
    "firecrawl": MCPServer(
        ...
        auth_type="api_key",
        description="Web scraping and crawling - extract content from any website",
        categories=["scraping", "web", "data"],
        keywords=[
            "scrape",
            "crawl",
            "extract",
        ...
        auth_env_var="FIRECRAWL_API_KEY",
    ),
    "sentry": MCPServer(
        name="sentry",
        ...
        categories=["monitoring", "errors", "debugging"],
        keywords=[
            "sentry",
            "error",
            "exception",
    ...
    "pinecone": MCPServer(
        ...
        categories=["database", "vector", "ai", "search"],
        keywords=[
            "pinecone",
            "vector",
            "embedding",
